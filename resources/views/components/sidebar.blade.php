<ul class="sidebar-menu">
    ...
    @if (Session::has('account'))
        ...
        <li class="menu-item">
            <a href="{{route('app.dashboard')}}" class="menu-label">
                <div class="icon">
        ...
        <li class="menu-item">
            <a href="{{route('contact.index', ['account' => Session::get('account')->id])}}" class="menu-label">
                <div class="icon">
        ...
        <li class="menu-item">
            <a href="{{route('company.index', ['account' => Session::get('account')->id])}}" class="menu-label">
                <div class="icon">
